 ...
 * # ngRoute
 *
 * The `ngRoute` module provides routing and deeplinking controller and directives for angular apps.
 *
 * ## Example
...
function $RouteProvider() {
  ...
  this.$get = ['$rootScope',
     ...
     * @description
     * Broadcasted before a route change. At this  point the route controller starts
